...
function Document ( data, collectionName, schema, fields, init ){
  ...
  //applyMethods(this, schema);
  //applyStatics(this, schema);
...
/*!
 * Register methods for this doc
 *
 * @param {Document} doc
 * @param {Schema} schema
 */
var applyMethods = function(doc, schema) {
  for (var i in schema.methods) {
    if (typeof schema.methods[i] === 'function') {
      doc.prototype[i] = schema.methods[i];
    } else {
      (function(_i) {
        Object.defineProperty(doc.prototype, _i, {
          get: function() {
            var h = {};
...
/*!
 * Register statics for this doc
 * @param {Document} doc
 * @param {Schema} schema
 */
var applyStatics = function(doc, schema) {
  for (var i in schema.statics) {
    // use defineProperty so that static props can't be overwritten
    Object.defineProperty(doc, i, {
