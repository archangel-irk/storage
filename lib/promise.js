...
/*!
 * @see https://github.com/aheckmann/mpromise
 */

//todo: избавиться от EventEmitter в пользу events.js
//todo: потом избавиться от зависимости jquery deferred в проекте
//todo: покрыть код promise.js тестами из оригинального репозитория
