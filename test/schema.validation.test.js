...
describe('schema', function(){
  describe('validation', function(){
    ...
    describe('messages', function(){
      describe('are customizable', function(){
        it('within schema definitions', function(done){
          ...
          var A = storage.createCollection('schema-validation-messages-'+random(), schema);
        ...
        it('for custom validators', function(done){
          ...
          var M = storage.createCollection('custom-validator-'+random(), schema);
    ...
    it('should allow an array of enums (gh-661)', function(done) {
      ...
      var Breakfast = storage.createCollection('gh-661', breakfastSchema, 'gh-661');

      var goodBreakfast = Breakfast.add({foods: ['eggs', 'bacon']});
      goodBreakfast.validate(function(error) {
        assert.ifError(error);

        var badBreakfast = Breakfast.add({foods: ['tofu', 'waffles', 'coffee']});
    ...
    describe('sync', function(){
      ...
      it('subdoc', function(done){
        ...
        assert.ok( err instanceof storage.Error.ValidationError );
        ...
        assert.ok( err1 instanceof storage.Error.ValidationError );
        ...
        assert.ok( err3 instanceof storage.Error.ValidationError );
        ...
        assert.ok( err4 instanceof storage.Error.ValidationError );
