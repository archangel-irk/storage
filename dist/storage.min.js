...
function applyGetters(self,json,type,options){for(var path,schema=self.schema,paths=Object.keys(schema[type]),i=paths.length;i--;){path=paths[i];for(var part,parts=path.split("."),plen=parts.length,last=plen-1,branch=json,ii=0;plen>ii;++ii)part=parts[ii],ii===last?branch[part]=utils.clone(self.get(path),options):branch=branch[part]||(branch[part]={})}return json}/*!
	 * Module dependencies.
	 */
var DocumentArray,Embedded,Events=__webpack_require__(9),StorageError=__webpack_require__(7),MixedSchema=__webpack_require__(17),ObjectId=__webpack_require__(15),Schema=__webpack_require__(2),ValidatorError=__webpack_require__(3).ValidatorError,Deferred=__webpack_require__(8),utils=__webpack_require__(6),clone=utils.clone,ValidationError=StorageError.ValidationError,InternalCache=__webpack_require__(18),deepEqual=utils.deepEqual;/*!
...
function scopePaths(array,fields,init){if(!init||!fields)return void 0;for(var hasKeys,key,path=array.path+".",keys=Object.keys(fields),i=keys.length,selected={};i--;)key=keys[i],0===key.indexOf(path)&&(hasKeys||(hasKeys=!0),selected[key.substring(path.length)]=fields[key]);return hasKeys&&selected||void 0}/*!
	 * Module dependencies.
	 */
var SchemaType=__webpack_require__(3),ArrayType=__webpack_require__(33),StorageDocumentArray=__webpack_require__(19),Subdocument=__webpack_require__(20),Document=__webpack_require__(5),oid=__webpack_require__(15),utils=__webpack_require__(6);/*!
