...
var StateMachine=__webpack_require__(10),ActiveRoster=StateMachine.ctor("require","modify","init","default");module.exports=InternalCache},function(module,exports,__webpack_require__){"use strict";function StorageDocumentArray(values,path,doc){var arr=[].concat(values);return _.mixin(arr,StorageDocumentArray.mixin),arr.validators=[],arr._path=path,arr.isStorageArray=!0,arr.isStorageDocumentArray=!0,doc&&(arr._parent=doc,arr._schema=doc.schema.path(path),arr._handlers={isNew:arr.notify("isNew"),save:arr.notify("save")},doc.on("save",arr._handlers.save),doc.on("isNew",arr._handlers.isNew)),arr}/*!
	 * Module dependencies.
	 */
var StorageArray=__webpack_require__(26),ObjectId=__webpack_require__(20),ObjectIdSchema=__webpack_require__(36),Document=__webpack_require__(5);/*!
...
function scopePaths(array,fields,init){if(!init||!fields)return void 0;for(var hasKeys,key,path=array.path+".",keys=Object.keys(fields),i=keys.length,selected={};i--;)key=keys[i],0===key.indexOf(path)&&(hasKeys||(hasKeys=!0),selected[key.substring(path.length)]=fields[key]);return hasKeys&&selected||void 0}/*!
	 * Module dependencies.
	 */
var SchemaType=__webpack_require__(3),ArrayType=__webpack_require__(33),StorageDocumentArray=__webpack_require__(24),Subdocument=__webpack_require__(25),Document=__webpack_require__(5),oid=__webpack_require__(20),utils=__webpack_require__(6);/*!
...
function defaultId(){return new oid}function resetId(v){return this.$__._id=null,v}/*!
	 * Module dependencies.
	 */
var Document,SchemaType=__webpack_require__(3),CastError=SchemaType.CastError,oid=__webpack_require__(20);/*!
	 * Inherits from SchemaType.
	 */
