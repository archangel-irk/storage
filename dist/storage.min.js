...
function getPositionalPath(self,path){var subpaths=path.split(/\.(\d+)\.|\.(\d+)$/).filter(Boolean);if(subpaths.length<2)return self.paths[subpaths[0]];var val=self.path(subpaths[0]);if(!val)return val;for(var subpath,last=subpaths.length-1,i=1;i<subpaths.length;++i){if(subpath=subpaths[i],i===last&&val&&!val.schema&&!/\D/.test(subpath)){val=val instanceof Types.Array?val.caster:void 0;break}if(/\D/.test(subpath)){if(!val||!val.schema){val=void 0;break}val=val.schema.path(subpath)}}return self.subpaths[path]=val,self.subpaths[path]}/*!
	 * Module dependencies.
	 */
var Types,schemas,Events=__webpack_require__(9),VirtualType=__webpack_require__(4),utils=__webpack_require__(6);/*!
...
function applyGetters(self,json,type,options){for(var path,schema=self.schema,paths=Object.keys(schema[type]),i=paths.length;i--;){path=paths[i];for(var part,parts=path.split("."),plen=parts.length,last=plen-1,branch=json,ii=0;plen>ii;++ii)part=parts[ii],ii===last?branch[part]=utils.clone(self.get(path),options):branch=branch[part]||(branch[part]={})}return json}/*!
	 * Module dependencies.
	 */
var DocumentArray,Embedded,Events=__webpack_require__(9),StorageError=__webpack_require__(7),MixedSchema=__webpack_require__(22),ObjectId=__webpack_require__(15),Schema=__webpack_require__(2),ValidatorError=__webpack_require__(3).ValidatorError,Deferred=__webpack_require__(8),utils=__webpack_require__(6),clone=utils.clone,ValidationError=StorageError.ValidationError,InternalCache=__webpack_require__(23),deepEqual=utils.deepEqual;/*!
...
exports.random=function(){return Math.random().toString().substr(3)},/*!
	 ...
	 * @api private
	 */
exports.isStorageObject=function(v){return Document||(Document=__webpack_require__(5)),v instanceof Document||v&&v.isStorageArray};var isStorageObject=exports.isStorageObject;/*!
...
module.exports=ValidationError},function(module,exports,__webpack_require__){"use strict";function ValidatorError(properties){var msg=properties.message;msg||(msg=errorMessages.general["default"]),this.properties=properties;var message=this.formatMessage(msg,properties);StorageError.call(this,message),this.name="ValidatorError",this.type=properties.type,this.path=properties.path,this.value=properties.value}/*!
	 * Module dependencies.
	 */
var StorageError=__webpack_require__(7),errorMessages=StorageError.messages;/*!
	 * Inherits from StorageError
	 */
...
module.exports=MissingSchemaError},function(module,exports,__webpack_require__){"use strict";function Mixed(path,options){if(options&&options["default"]){var def=options["default"];Array.isArray(def)&&0===def.length?options["default"]=Array:!options.shared&&_.isPlainObject(def)&&0===Object.keys(def).length&&(options["default"]=function(){return{}})}SchemaType.call(this,path,options)}/*!
	 * Module dependencies.
	 */
var SchemaType=__webpack_require__(3);/*!
...
Mixed.prototype=Object.create(SchemaType.prototype),Mixed.prototype.constructor=Mixed,Mixed.prototype.checkRequired=function(val){return void 0!==val&&null!==val},Mixed.prototype.cast=function(value){return value},/*!
	 * Module exports.
	 */
module.exports=Mixed},function(module,exports,__webpack_require__){"use strict";function InternalCache(){this.strictMode=void 0,this.selected=void 0,this.saveError=void 0,this.validationError=void 0,this.adhocPaths=void 0,this.removing=void 0,this.inserting=void 0,this.version=void 0,this.getters={},this._id=void 0,this.populate=void 0,this.populated=void 0,this.wasPopulated=!1,this.scope=void 0,this.activePaths=new ActiveRoster,this.ownerDocument=void 0,this.fullPath=void 0}/*!
	 * Dependencies
	 */
var StateMachine=__webpack_require__(10),ActiveRoster=StateMachine.ctor("require","modify","init","default");module.exports=InternalCache},function(module,exports,__webpack_require__){"use strict";function StorageDocumentArray(values,path,doc){var arr=[].concat(values);return _.mixin(arr,StorageDocumentArray.mixin),arr.validators=[],arr._path=path,arr.isStorageArray=!0,arr.isStorageDocumentArray=!0,doc&&(arr._parent=doc,arr._schema=doc.schema.path(path),arr._handlers={isNew:arr.notify("isNew"),save:arr.notify("save")},doc.on("save",arr._handlers.save),doc.on("isNew",arr._handlers.isNew)),arr}/*!
	 * Module dependencies.
	 */
var StorageArray=__webpack_require__(26),ObjectId=__webpack_require__(15),ObjectIdSchema=__webpack_require__(36),Document=__webpack_require__(5);/*!
...
StorageDocumentArray.mixin=Object.create(StorageArray.mixin),StorageDocumentArray.mixin._cast=function(value){return value instanceof this._schema.casterConstructor?(value.__parent&&value.__parentArray||(value.__parent=this._parent,value.__parentArray=this),value):((value instanceof ObjectId||!_.isObject(value))&&(value={_id:value}),new this._schema.casterConstructor(value,this))},StorageDocumentArray.mixin.id=function(id){var casted,sid,_id;try{var casted_=ObjectIdSchema.prototype.cast.call({},id);casted_&&(casted=String(casted_))}catch(e){casted=null}for(var i=0,l=this.length;l>i;i++)if(_id=this[i].get("_id"),_id instanceof Document){if(sid||(sid=String(id)),sid==_id._id)return this[i]}else if(_id instanceof ObjectId){if(casted==_id)return this[i]}else if(sid||(sid=String(id)),sid==_id)return this[i];return null},StorageDocumentArray.mixin.toObject=function(options){return this.map(function(doc){return doc&&doc.toObject(options)||null})},StorageDocumentArray.mixin.create=function(obj){return new this._schema.casterConstructor(obj)},StorageDocumentArray.mixin.notify=function(event){var self=this;return function(val){for(var i=self.length;i--;)self[i]&&self[i].trigger(event,val)}},/*!
	 * Module exports.
	 */
module.exports=StorageDocumentArray},function(module,exports,__webpack_require__){"use strict";function EmbeddedDocument(data,parentArr){parentArr?(this.__parentArray=parentArr,this.__parent=parentArr._parent):(this.__parentArray=void 0,this.__parent=void 0),Document.call(this,data,void 0);var self=this;this.on("isNew",function(val){self.isNew=val})}/*!
	 * Module dependencies.
	 */
var Document=__webpack_require__(5),Deferred=__webpack_require__(8);/*!
...
SchemaArray.prototype=Object.create(SchemaType.prototype),SchemaArray.prototype.constructor=SchemaArray,SchemaArray.prototype.checkRequired=function(value){return!(!value||!value.length)},SchemaArray.prototype.applyGetters=function(value,scope){return this.caster.options&&this.caster.options.ref?value:SchemaType.prototype.applyGetters.call(this,value,scope)},SchemaArray.prototype.cast=function(value,doc,init){if(Array.isArray(value)){if(value.isStorageArray||(value=new StorageArray(value,this.path,doc)),this.caster)try{for(var i=0,l=value.length;l>i;i++)value[i]=this.caster.cast(value[i],doc,init)}catch(e){throw new CastError(e.type,value,this.path)}return value}return doc&&init&&doc.markModified(this.path),this.cast([value],doc,init)},/*!
	 * Module exports.
	 */
module.exports=SchemaArray},function(module,exports,__webpack_require__){(function(Buffer){"use strict";function SchemaBuffer(key,options){SchemaType.call(this,key,options,"Buffer")}/*!
	 * Module dependencies.
	 */
var Document,SchemaType=__webpack_require__(3),CastError=SchemaType.CastError,StorageBuffer=__webpack_require__(11).Buffer,Binary=StorageBuffer.Binary;/*!
	 * Inherits from SchemaType.
	 */
SchemaBuffer.prototype=Object.create(SchemaType.prototype),SchemaBuffer.prototype.constructor=SchemaBuffer,SchemaBuffer.prototype.checkRequired=function(value,doc){return SchemaType._isRef(this,value,doc,!0)?null!=value:!(!value||!value.length)},SchemaBuffer.prototype.cast=function(value,doc,init){var ret;if(SchemaType._isRef(this,value,doc,init)){if(null==value)return value;if(Document||(Document=__webpack_require__(5)),value instanceof Document)return value.$__.wasPopulated=!0,value;if(Buffer.isBuffer(value))return value;if(!_.isObject(value))throw new CastError("buffer",value,this.path);var path=doc.$__fullPath(this.path),owner=doc.ownerDocument?doc.ownerDocument():doc,pop=owner.populated(path,!0);return ret=new pop.options.model(value),ret.$__.wasPopulated=!0,ret}if(value&&value._id&&(value=value._id),Buffer.isBuffer(value))return value&&value.isStorageBuffer||(value=new StorageBuffer(value,[this.path,doc])),value;if(value instanceof Binary){if(ret=new StorageBuffer(value.value(!0),[this.path,doc]),"number"!=typeof value.sub_type)throw new CastError("buffer",value,this.path);return ret._subtype=value.sub_type,ret}if(null===value)return value;var type=typeof value;if("string"===type||"number"===type||Array.isArray(value))return ret=new StorageBuffer(value,[this.path,doc]);throw new CastError("buffer",value,this.path)},/*!
	 * Module exports.
	 */
module.exports=SchemaBuffer}).call(exports,__webpack_require__(12).Buffer)},function(module,exports,__webpack_require__){"use strict";function DateSchema(key,options){SchemaType.call(this,key,options)}/*!
	 * Module requirements.
	 */
var SchemaType=__webpack_require__(3),CastError=SchemaType.CastError;/*!
	 * Inherits from SchemaType.
	 */
